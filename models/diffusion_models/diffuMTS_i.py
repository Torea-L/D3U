...
from models.denoise_models.PatchDN import PatchDN
from models.denoise_models.MLP import MLP
from models.denoise_models.CNN import CNN_DiffusionUnet
...
class Model(nn.Module):
    ...
    def q_sample(self, y, t, noise=None):
        # y=y_0(ground truth), y_T_mean(learned by point foreccasting model), 
        # self.model.alphas_bar_sqrt,self.model.one_minus_alphas_bar_sqrt, t（时间步骤), noise=e（高斯噪声）
        """
    ...
    def fast_sample(self,y_T_mean,enc_out, y_shape,eta):
            ...
            for time, time_next in tqdm(time_pairs, desc='sampling loop time step'):
                ...
                pred_noise = self.diffussion_model(y_t, time_cond,enc_out)                    # dec_out: [bs, nvars, pred_len]                 # dec_out: [bs x nvars x pred_len]
